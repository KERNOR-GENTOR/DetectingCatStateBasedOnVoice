...
const uint8_t Mic_ConfigDescriptor[] = {
		...
		0x00, //tSamFreq: 32000Hz (0x007D00) //
		0x7D,
		0x00,
		...
		0x40, // wMaxPacketSize: 64 bytes per packet (0x0040) 
		0x00,
		0x01, // bInterval: one packet per frame 1 ms send interval
