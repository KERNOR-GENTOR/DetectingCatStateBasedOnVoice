...
namespace SoundClassificationDotNetInteractive
{
    class Program
    {
        private static string Features3SecondsPath = "features_3_sec.csv";
        private static string SampleAudioFilePath = "F_BAC01_MC_MN_SIM01_102.wav";
        private static string[] Labels = Enumerable.Range(1, 30).Select(x => x.ToString()).ToArray();
